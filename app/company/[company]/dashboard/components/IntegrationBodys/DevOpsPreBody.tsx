...
export const DevOpsPreBody = ({ integrationKey }: { integrationKey: string }) => {
  ...
  const onActionTaskClick = (el: DisplayedElementProps) => {
  ...
  return (
<div className="w-full flex flex-row gap-2 items-stretch h-[80vh] min-h-0">
      {showFeatureModal && creatingElement && (
          ...
          <div className="space-y-1.5">
            ...
            {asignee && (
              <p className="text-xs text-slate-500">
                Currently assigned to <span className="font-medium">No assignee</span>
              </p>
            )}
          </div>
        </div>
