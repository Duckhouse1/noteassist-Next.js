        ...
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="mx-auto w-full max-w-7xl 2xl:max-w-[1600px] px-4 sm:px-6 lg:px-8 py-8">
                ...
                {/* <div className="mt-16">
                    {currentAction && (
                        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            <h2 className="text-xl font-semibold text-slate-900">{currentAction.title}</h2>
                            <p className="mt-2 text-sm text-slate-700">{currentAction.description}</p>
                            <button
                                type="button"
                                className="mt-4 rounded-lg bg-blue-900 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-200"
