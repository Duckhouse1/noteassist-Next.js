...
export type ConfigState = {
  ...
  enabledProviders: IntegrationOptions[];
};
...
export function ConfigurationPage({
  ...
  function toggleProvider(provider: IntegrationOptions) {
    ...
    onChange({
      ...value,
      enabledProviders: toggleInArray(value.enabledProviders, provider),
    });
  }
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
            ...
            <div className="mt-4">
              ...
              >
                {providers.map((provider) => {
                  const active = value.enabledProviders.includes(provider);
                  return (
                    <button
                      key={provider}
                      type="button"
        ...
        <aside className="space-y-4">
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-5 text-sm text-slate-600">
            This configuration controls which actions are visible on the
            front page for this company.
          </div>
        </aside>
      </div>
    </div>
