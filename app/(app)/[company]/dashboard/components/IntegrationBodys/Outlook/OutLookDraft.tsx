                    ...
                    <div className="w-full max-w-md mx-4 rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden">
                        ...
                        <div className="px-6 py-5">
                            ...
                            <div className="rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 space-y-1.5">
                                <div className="flex gap-2 text-sm">
                                    ...
                                    <span className="text-slate-800 truncate">{emailDraft.recipients.join(", ")}</span>
                                </div>
                                <div className="flex gap-2 text-sm">
                                    <span className="font-medium text-slate-500 w-14 shrink-0">Subject:</span>
                                    <span className="text-slate-800 truncate">{emailDraft.subject}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3 border-t border-slate-100 px-6 py-4">
                            <button
                                ...
                                disabled={isSending}
                                className="flex-1 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                disabled={isSending}
                                className="flex-1 rounded-lg bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700 disabled:opacity-60 flex items-center justify-center gap-2"
                            >
                                {isSending ? (
                                    <>
