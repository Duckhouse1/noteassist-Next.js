...
export function JiraIssueInfoPanel({ selectedElement, availableTypes, sites, projects, loadingProjects, onDataChange, onSiteChange }: JiraIssueInfoPanelProps) {
            ...
            <div className={`flex-1 min-h-0 overflow-y-auto pt-0 ${s("px-2 pb-6", "px-1 pb-3")}`}>
                <div className={`flex flex-col ${s("gap-3", "gap-2")}`}>
                    ...
                    <div className={s("space-y-2", "space-y-1")}>
                        <label className={`font-medium text-slate-700 ${s("text-sm", "text-xs")}`}>Title</label>
                        <input
                            ref={titleInputRef}
                            value={selectedElement.data.title}
                            onChange={(e) => onDataChange({ title: e.target.value })}
                            className={`w-full rounded-lg border border-slate-200 bg-white text-slate-900 shadow-sm outline-none transition focus:border-slate-300 focus:ring-4 focus:ring-blue-100 ${s("px-3 py-2.5 text-sm", "px-2 py-1.5 text-xs")}`}
                        ...
                        <div className={`grid grid-cols-1 sm:grid-cols-2 ${s("gap-3", "gap-2")}`}>
                            <div className={s("space-y-1.5", "space-y-1")}>
                                ...
                                <select
                                    ...
                                    className={`w-full rounded-lg border border-slate-200 bg-white text-slate-900 shadow-sm outline-none transition focus:border-slate-300 focus:ring-4 focus:ring-blue-100 ${s("px-3 py-2 text-sm", "px-2 py-1 text-xs")}`}
                                >
                            ...
                            <div className={s("space-y-1.5", "space-y-1")}>
                                ...
                                <select
                                    ...
                                    className={`w-full rounded-lg border border-slate-200 bg-white text-slate-900 shadow-sm outline-none transition focus:border-slate-300 focus:ring-4 focus:ring-blue-100 disabled:bg-slate-50 disabled:text-slate-400 ${s("px-3 py-2 text-sm", "px-2 py-1 text-xs")}`}
                                >
                    ...
                    {/* Issue Type */}
                    <div className={s("space-y-1.5", "space-y-1")}>
                        <label className={`font-medium text-slate-700 ${s("text-sm", "text-xs")}`}>Issue Type</label>
                    ...
                    <div>
                        ...
                        <div className={s("pt-2", "pt-1")}>
                            <textarea
                                ...
                                className={`w-full rounded-lg border border-slate-200 bg-white text-slate-900 shadow-sm outline-none transition focus:border-slate-300 focus:ring-4 focus:ring-blue-100 ${s("min-h-[180px] px-3 py-2.5 text-sm", "min-h-[120px] px-2 py-1.5 text-xs")}`}
